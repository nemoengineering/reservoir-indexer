...
import { BaseBuilder } from "@reservoir0x/sdk/dist/payment-processor-v2.1/builders/base";

import { redb } from "@/common/db";
import { config } from "@/config/index";
import * as utils from "@/orderbook/orders/payment-processor-v2.1/build/utils";
...
export const build = async (options: BuildOrderOptions) => {
  ...
  const builder: BaseBuilder = new Sdk.PaymentProcessorV21.Builders.ContractWide(config.chainId);
