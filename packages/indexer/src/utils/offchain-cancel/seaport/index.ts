    ...
    try {
      if (
        ...
        if (info) {
          ...
          if (
            configV3 &&
            configV3.transferValidator === Sdk.Erc721c.Addresses.TransferValidatorV4[config.chainId]
          ) {
            ...
            logger.info(
              ...
              JSON.stringify({
                ...
                message: `Using transferValidatorV4. orderId=${orderId}, transferValidator=${transferValidator}`,
              })
            );
          }
        }
