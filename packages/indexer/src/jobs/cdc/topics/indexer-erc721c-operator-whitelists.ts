...
export class IndexerErc721cOperatorWhitelistsHandler extends KafkaEventHandler {
  topicName = "indexer.public.erc721c_operator_whitelists";
  ...
  protected async handleUpdate(payload: any): Promise<void> {
    ...
    if (changed.some((value) => ["whitelist"].includes(value))) {
      await collectionSecurityConfigUpdatedJob.addToQueue([
        {
          by: "transferValidator",
          data: {
