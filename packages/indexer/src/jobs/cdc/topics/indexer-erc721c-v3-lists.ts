...
export class IndexerErc721cV3ListsHandler extends KafkaEventHandler {
  topicName = "indexer.public.erc721c_v3_lists";
  ...
  protected async handleUpdate(payload: any): Promise<void> {
    ...
    if (changed.some((value) => ["whitelist", "blacklist", "authorizers"].includes(value))) {
      await collectionSecurityConfigUpdatedJob.addToQueue([
        {
          by: "transferValidator",
          data: {
