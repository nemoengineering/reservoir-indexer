...
export class IndexerErc721cV2ListsHandler extends KafkaEventHandler {
  topicName = "indexer.public.erc721c_v2_lists";
  ...
  protected async handleUpdate(payload: any): Promise<void> {
    ...
    if (changed.some((value) => ["whitelist", "blacklist"].includes(value))) {
      await collectionSecurityConfigUpdatedJob.addToQueue([
        {
          by: "transferValidator",
          data: {
