...
export const configureFixedPriceSale: EventData = {
  kind: "foundation",
  subKind: "foundation-configure-fixed-price-sale",
  addresses: { [Foundation.Addresses.MultiTokenDropMarket[config.chainId]?.toLowerCase()]: true },
  topic: "0x8536db4b44245f8a17fb344184146f78688a6f8e33670eff6ad85831ac7dc33b",
  numTopics: 4,
  abi: new Interface([
