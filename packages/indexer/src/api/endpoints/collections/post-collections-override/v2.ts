...
export const postCollectionsOverrideV2Options: RouteOptions = {
  ...
  validate: {
    ...
    payload: Joi.object({
      ...
      twitterUsername: Joi.string().allow("").optional(),
      twitterUrl: Joi.string().allow("").optional(),
      discordUrl: Joi.string().allow("").optional(),
      externalUrl: Joi.string().allow("").optional(),
      magicedenVerificationStatus: Joi.string().allow("").optional(),
      royalties: Joi.array()
        .items(
          Joi.object({
            bps: Joi.number(),
      ...
      .min(1)
      .description(
        "Params that can be passed in order to override existing ones, to disable override pass an empty string"
      ),
  },
  response: {
    schema: Joi.object({
