  ...
  validate: {
    query: Joi.object({
      ...
      limit: Joi.number()
        ...
        .max(1000)
        .default(50)
        .description("Amount of items returned in response. Max is 1000"),
    ...
    try {
      ...
      let baseQuery = `
        SELECT
          ...
          order_events.order_currency AS order_events_order_currency,
          order_events.order_kind AS order_events_order_kind,
          ${t}.order_currency,
          ${t}.order_dynamic,
          ...
          order: {
            ...
            price: r.price
              ? await getJoiPriceObject(
                  ...
                  fromBuffer(r.order_currency ?? r.order_events_order_currency),
            ...
            kind: r.order_kind ?? r.order_events_order_kind,
