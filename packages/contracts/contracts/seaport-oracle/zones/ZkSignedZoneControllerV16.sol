...
/**
 * @title  ZkSignedZoneControllerV16
 * @author BCLeFevre
 * @dev    This is a zk-compatible version of SignedZoneControllerV16. It uses
 *         the SignedZoneV16 runtime codehash to derive the zone address
 ...
 */
contract ZkSignedZoneControllerV16 is
    ...
    SignedZoneControllerEventsAndErrors
{
    ...
    constructor() {
        ...
        SignedZoneV16 zeroSignedZone = new SignedZoneV16{salt: bytes32(0)}();
    ...
    function createZone(
        ...
        address signedZoneAddress = address(new SignedZoneV16{salt: salt}());
        ...
        if (active) {
            ...
            for (uint256 i = 0; i < signedZoneProperties.activeSignerList.length; ) {
                if (signedZoneProperties.activeSignerList[i] == signer) {
                    signedZoneProperties.activeSignerList[i] = signedZoneProperties
                        .activeSignerList[signedZoneProperties.activeSignerList.length - 1];
